--In 12.sql, write a SQL query to list
--the titles of all movies in which both
...
--in the database with the name Bradley Cooper.
--You may assume that there is only one person
--in the database with the name Jennifer Lawrence.
