--In 9.sql, write a SQL query to list the
--names of all people who starred in a movie released
...
--No need to worry about people who have
--no birth year listed, so long as
