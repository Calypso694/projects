...
if not API_KEY:
    # Optionally, set a default API key or handle the error gracefully
    API_KEY = "default_api_key"  # Replace with a valid default key if necessary
    # Alternatively, you could log a warning or prompt the user
    print("Warning: API_KEY not set. Using default API key.")
